...
public class OrganizationRegistrationFormPanel extends DefaultFormPanel
{
    public OrganizationRegistrationFormPanel(final String componentName, final FormMode mode)
    {
    ...
    protected OrgRegistrationForm createForm(final String componentName, final IFeedback feedback, final FormMode mode)
    {
        ...
        final AddOrganization newOrgParameters = new OrgRegistrationFormModel(); //service.getOrganizationParameters();       // TODO: use service once it is ready.
        return new OrgRegistrationForm(componentName, feedback, new BoundCompoundPropertyModel(new OrgRegistrationFormModel(/*newOrgParameters*/)), newOrgParameters, mode, RegisterPatientParameters.class); // TODO: add newOrgParameters once service is ready
    }
