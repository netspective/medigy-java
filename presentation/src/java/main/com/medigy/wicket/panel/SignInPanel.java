 ...
 */
public abstract class SignInPanel extends DefaultPanel
{
	 ...
	 * Sign in form.
	 */
	public final class SignInForm extends BaseForm
	{
		...
		public SignInForm(final String componentName, final IFeedback feedback)
		{
			...
			add(username = new RequiredTextField("username", new PropertyModel(properties,
					"username")));
	...
	public SignInPanel(final String componentName, final boolean includeRememberMe)
	{
		...
		border.add(new SignInForm("signInForm", feedback));
	}
