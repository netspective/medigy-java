...
/**
 * Interface for DTO containing data specific to the Edit Patient service
 */
public interface EditPatientParameters extends ServiceParameters
{

    /**
     * Gets the patient's db primary key.
     * @return id
     */
    @NotNull
