...
public class CurrencyField extends wicket.markup.html.form.TextField implements FormJavaScriptGenerator.Contributor
{

    public static class CurrencyFieldCreator implements FormFieldFactory.FieldCreator
    {
        public FormComponent createField(final String controlId, final ReflectedFormFieldDefn reflectedFormFieldDefn)
        {
            final CurrencyField result = new CurrencyField(controlId, reflectedFormFieldDefn);
    ...
    public CurrencyField(final String controlId, final ReflectedFormFieldDefn reflectedFormFieldDefn)
    {
        super(controlId);
