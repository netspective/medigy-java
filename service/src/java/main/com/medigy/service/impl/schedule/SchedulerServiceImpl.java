...
import com.medigy.service.schedule.ScheduleService;
...
public class SchedulerServiceImpl implements ScheduleService
{
    ...
    private SchedulerFacadeImpl schedulerFacade;

    public SchedulerServiceImpl(final SchedulerFacadeImpl schedulerFacade)
    {
    ...
    {
        final HealthCareEncounter[] encounters = schedulerFacade.listEncountersByDateRange(parameters.getStartDateAndTime(), parameters.getEndDateAndTime());
    ...
    public ServiceReturnValues createErrorResponse(final ServiceParameters params, final String errorMessage)
    {
        return new ScheduleReturnValues()
        {
            ...
            public ScheduleParameters getParameters()
            {
                return (ScheduleParameters) params;
            }
