...
public class BloodType extends AbstractReferenceEntity
{
    public static final String PK_COLUMN_NAME = "blood_type_id";
    ...
    public enum Cache implements CachedReferenceEntity
    {
        ...
        {
            this.entity = (BloodType) entity;
        }

        public static BloodType getEntity(String code)
        {
            for (BloodType.Cache blood : BloodType.Cache.values())
            {
                if (blood.getCode().equals(code))
                    return blood.getEntity();
            }
            return null;
        }
    }
