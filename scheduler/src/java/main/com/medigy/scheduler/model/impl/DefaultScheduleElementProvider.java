...
import com.medigy.scheduler.model.ScheduleEvents;
...
import com.medigy.scheduler.model.ScheduleTemplates;
import com.medigy.scheduler.util.CalendarUtils;
import com.medigy.scheduler.util.set.DaysOfWeekSet;

public class DefaultScheduleElementProvider implements ScheduleEventProvider, ScheduleTemplateProvider, ScheduleParticipantProvider
{
    ...
    public ScheduleEvents getScheduledEvents(ScheduleManager scheduleManager, Date beginDate, Date endDate)
    {
        ...
        for(int day = beginDay; day <= endDay; day++)
        {
            ...
            for(int i = 0; i < MOCK_EVENT_HOURS.length; i++)
            {
                ...
                result.addEvent(new DefaultScheduleEvent(scheduleManager, calendarUtils.createDate(julianDate, hm[0], hm[1]),
