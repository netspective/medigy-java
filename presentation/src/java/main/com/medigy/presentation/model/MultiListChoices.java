...
/**
 * Simple choice list for providing choices in a static MultiList. This class implements
 * {@link wicket.markup.html.form.model.IChoiceList}so that it is easier to
 * create subclasses and anonymous implementations.
 */
public class MultiListChoices implements IChoiceList
{
	 ...
	 */
	public MultiListChoices(final Class entity)
	{
        this.entity = entity;
