...
public class TestEditPatientService extends AbstractSpringTestCase
{
    private static final Log log = LogFactory.getLog(TestEditPatientService.class);

    private PatientRegistrationService patientRegistrationService;
    private EditPatientService editPatientService;

    public void setPatientRegistrationService(final PatientRegistrationService patientRegistrationService, final EditPatientService editPatientService)
    {
        this.patientRegistrationService = patientRegistrationService;
        this.editPatientService = editPatientService;
    }

    public void XtestEditPatientService()
    {
        ...
        final Person persistedPerson = (Person) getSession().get(Person.class, registeredPatient.getPatientId());
        ...
        // TEST EDIT SERVICE
        EditPatientParameters editPatientParameters = null;
        try
        {
            editPatientParameters = new EditPatientParameters()
            {
                ...
                public List<String> getEthnicityCodes()
                {
                    return Arrays.asList(new String[] { EthnicityType.Cache.HISPANIC.getCode(), EthnicityType.Cache.HISPANIC.getCode() });
                }
                ...
                public String getDriversLicenseStateCode()
                {
                    return State.Cache.CALIFORNIA.getEntity().getStateAbbreviation();
                }
        ...
        editPatientService.editPatient(editPatientParameters);
