...
public class MedigyReferenceDocumentationProvider implements MappedClassDocumentationProvider
{
    public void provideDocumentationFragments(final DatabaseDesignGeneratorConfig generator, final TableStructureNode node, final Element parentElement)
    {
        ...
        final Map<Class, Class> refEntityAndCachesMap = hibernateConfiguration.getReferenceEntitiesAndCachesMap();
        ...
        tableColumnsHeadRowElem.appendChild(doc.createElement("entry")).appendChild(doc.createTextNode("ID"));
