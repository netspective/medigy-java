...
/**
 * Simple choice list for providing choices in a dynamic MultiList. This class implements
 * {@link wicket.markup.html.form.model.IChoiceList}so that it is easier to
 * create subclasses and anonymous implementations.
 */
public class MultiCheckChoices implements IChoiceList
{
	 ...
	 */
	public MultiCheckChoices(final Class entity)
	{
        this.entity = entity;
	...
	/**
	 * @see wicket.markup.html.form.model.IChoiceList#attach()
	 */
	public void attach()
	{
	}
	...
	/**
	 * @see wicket.markup.html.form.model.IChoiceList#choiceForId(String)
	 */
	...
	/**
	 * @see wicket.markup.html.form.model.IChoiceList#choiceForObject(Object)
	 */
