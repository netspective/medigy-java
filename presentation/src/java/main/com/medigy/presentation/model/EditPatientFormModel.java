...
public final class EditPatientFormModel implements EditPatientParameters
{
    ...
    private EditPatientParameters params;


	public EditPatientFormModel(EditPatientParameters params)
	{
        this.params = params;
        this.setFirstName(params.getFirstName());
        this.setLastName(params.getLastName());
        this.setMiddleName(params.getMiddleName());
        this.setSuffix(params.getSuffix());
        this.setBirthDate(params.getBirthDate());
        this.setDeathDate(params.getDeathDate());

        // TODO: BeanUtils throwing HibernateSession exception during copyProperties execution - we need to use eager fectching for person lookup or get session again.
//        try
//        {
...
//        catch(Exception e)
//        {
//            System.out.println("BeanUtils exception" + e);
//        }
	}
