...
public class CurrencyField extends wicket.markup.html.form.TextField implements JavaScriptProvider
{
    ...
    public static class CurrencyFieldCreator implements FormFieldFactory.FieldCreator
    {
        ...
        {
            final CurrencyField result = new CurrencyField(reflectedFieldDefn);
    ...
    public CurrencyField(final ReflectedFormFieldDefn reflectedFieldDefn)
    {
